...
namespace Commons.Media.PortAudio
{
    public class Configuration
	{
		...
		public static int HostApiCount {
			get { return (int)PortAudioInterop.Pa_GetHostApiCount (); }
		}
		
		public static int DefaultHostApi {
			get { return (int)PortAudioInterop.Pa_GetDefaultHostApi (); }
		}
		...
		{
			return (int)PortAudioInterop.Pa_HostApiTypeIdToHostApiIndex (type);
		}
		
		public static int HostApiDeviceIndexToDeviceIndex (int hostApi, int hostApiDeviceIndex)
		{
			return (int)PortAudioInterop.Pa_HostApiDeviceIndexToDeviceIndex(hostApi, hostApiDeviceIndex);
		}
		...
		public static int DeviceCount {
            get { return (int)PortAudioInterop.Pa_GetDeviceCount (); }
		}
		
		public static int DefaultInputDevice {
            get { return (int)PortAudioInterop.Pa_GetDefaultInputDevice (); }
		}
		
		public static int DefaultOutputDevice {
            get { return (int)PortAudioInterop.Pa_GetDefaultOutputDevice (); }
		}
		
		public static PaDeviceInfo GetDeviceInfo (short deviceIndex)
		{
		...
		unsafe public static PaErrorCode CheckIfFormatSupported (PaStreamParameters inputParameters, PaStreamParameters outputParameters, double sampleRate)
		{
			using (var input = Factory.ToNative<PaStreamParameters> (inputParameters))
				using (var output = Factory.ToNative<PaStreamParameters> (outputParameters))
					return PortAudioInterop.Pa_IsFormatSupported (input.Native, (int*)output.Native, sampleRate);
		}
